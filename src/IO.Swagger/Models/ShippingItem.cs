...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShippingItem :  IEquatable<ShippingItem>
    {
                /// <summary>
        ...
        public ShippingItem(Dictionary<string, Property> AdditionalProperties = default(Dictionary<string, Property>), List<Behavior> Behaviors = default(List<Behavior>), string Category = default(string), List<string> Countries = default(List<string>), bool? Displayable = default(bool?), List<string> GeoCountryList = default(List<string>), GeoPolicyTypeEnum? GeoPolicyType = default(GeoPolicyTypeEnum?), string LongDescription = default(string), int? MaxTierTotal = default(int?), string Name = default(string), int? ShippingTier = default(int?), string ShortDescription = default(string), List<Sku> Skus = default(List<Sku>), int? Sort = default(int?), long? StoreEnd = default(long?), long? StoreStart = default(long?), List<string> Tags = default(List<string>), bool? Taxable = default(bool?), string Template = default(string), string TypeHint = default(string), string UniqueKey = default(string), int? VendorId = default(int?))
        {
        ...
        [DataMember(Name="max_tier_total")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((ShippingItem)obj);
        }
        ...
        public static bool operator ==(ShippingItem left, ShippingItem right)
        {
