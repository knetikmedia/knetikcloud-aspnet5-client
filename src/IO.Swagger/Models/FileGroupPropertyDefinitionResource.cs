...
namespace IO.Swagger.Models
{
    ...
    public partial class FileGroupPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<FileGroupPropertyDefinitionResource>
    {
        ...
        public FileGroupPropertyDefinitionResource(PropertyFieldListResource FieldList = default(PropertyFieldListResource), string Name = default(string), bool? Required = default(bool?), string Type = default(string), string FileType = default(string), int? MaxCount = default(int?), long? MaxFileSize = default(long?), int? MinCount = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((FileGroupPropertyDefinitionResource)obj);
        }

        /// <summary>
        /// Returns true if FileGroupPropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of FileGroupPropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileGroupPropertyDefinitionResource other)
        {
        ...
        public static bool operator ==(FileGroupPropertyDefinitionResource left, FileGroupPropertyDefinitionResource right)
        {
