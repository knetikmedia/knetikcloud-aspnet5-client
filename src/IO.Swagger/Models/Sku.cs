...
namespace IO.Swagger.Models
{
    ...
    public partial class Sku :  IEquatable<Sku>
    {
        ...
        /// <param name="Price">The current price of the SKU with sales, if any. Set original_price for the base.</param>
        /// <param name="Published">Whether or not the SKU is currently published.</param>
        /// <param name="SaleId">The id of a sale affecting the price, if any.</param>
        /// <param name="SaleName">The name of a sale affecting the price, if any.</param>
        ...
        public Sku(Dictionary<string, Property> AdditionalProperties = null, string CurrencyCode = null, string Description = null, int? Inventory = null, int? MinInventoryThreshold = null, double? OriginalPrice = null, double? Price = null, bool? Published = null, int? SaleId = null, string SaleName = null, string _Sku = null, long? StartDate = null, long? StopDate = null)
        {
        ...
        [DataMember(Name="min_inventory_threshold")]
