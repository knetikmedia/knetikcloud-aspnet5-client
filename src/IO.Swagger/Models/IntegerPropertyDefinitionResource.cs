...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegerPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<IntegerPropertyDefinitionResource>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerPropertyDefinitionResource" /> class.
        /// </summary>
        ...
        public IntegerPropertyDefinitionResource(PropertyFieldListResource FieldList = default(PropertyFieldListResource), string Name = default(string), bool? Required = default(bool?), string Type = default(string), int? Max = default(int?), int? Min = default(int?))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for IntegerPropertyDefinitionResource and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Required == null)
            {
                throw new InvalidDataException("Required is a required property for IntegerPropertyDefinitionResource and cannot be null");
            }
            else
            {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for IntegerPropertyDefinitionResource and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((IntegerPropertyDefinitionResource)obj);
        }

        /// <summary>
        /// Returns true if IntegerPropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of IntegerPropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegerPropertyDefinitionResource other)
        {
        ...
        public static bool operator ==(IntegerPropertyDefinitionResource left, IntegerPropertyDefinitionResource right)
        {
