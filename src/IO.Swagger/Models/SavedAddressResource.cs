...
namespace IO.Swagger.Models
{
    ...
    public partial class SavedAddressResource :  IEquatable<SavedAddressResource>
    {
        ...
        public SavedAddressResource(string Address1 = default(string), string Address2 = default(string), string City = default(string), string CountryCode = default(string), bool? Default = default(bool?), string FirstName = default(string), string LastName = default(string), string Name = default(string), string Phone1 = default(string), string Phone2 = default(string), string PostalCode = default(string), string StateCode = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((SavedAddressResource)obj);
        }
        ...
        public static bool operator ==(SavedAddressResource left, SavedAddressResource right)
        {
