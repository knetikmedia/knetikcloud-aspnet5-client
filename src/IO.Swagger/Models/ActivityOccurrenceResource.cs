...
namespace IO.Swagger.Models
{
    ...
    public partial class ActivityOccurrenceResource :  IEquatable<ActivityOccurrenceResource>
    {
        ...
        /// <param name="Settings">The list of settings and their options available for this activity. Should be null on create if and only if part of an event. Otherwise, the set must exactly match those of the activity..</param>
        ...
        /// </summary>
        /// <value>The list of settings and their options available for this activity. Should be null on create if and only if part of an event. Otherwise, the set must exactly match those of the activity.</value>
