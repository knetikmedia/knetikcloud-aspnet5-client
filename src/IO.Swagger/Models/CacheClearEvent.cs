...
namespace IO.Swagger.Models
{
    ...
    public partial class CacheClearEvent : BroadcastableEvent,  IEquatable<CacheClearEvent>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CacheClearEvent)obj);
        }

        /// <summary>
        /// Returns true if CacheClearEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of CacheClearEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CacheClearEvent other)
        {
        ...
        public static bool operator ==(CacheClearEvent left, CacheClearEvent right)
        {
