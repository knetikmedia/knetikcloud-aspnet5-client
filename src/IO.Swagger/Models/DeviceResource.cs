...
namespace IO.Swagger.Models
{
    ...
    public partial class DeviceResource :  IEquatable<DeviceResource>
    {
        ...
        /// <param name="Id">The unique ID for this device (required).</param>
        /// <param name="Location">The OS (operating system) on the device.</param>
        ...
        public DeviceResource(string Authorization = null, string Condition = null, long? CreatedDate = null, Dictionary<string, string> Data = null, string Description = null, string DeviceType = null, int? Id = null, string Location = null, string MacAddress = null, string Make = null, string Model = null, string Name = null, string Os = null, string Serial = null, string Status = null, long? UpdatedDate = null, SimpleUserResource User = null)
        {
