...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveCustomerEvent : BroadcastableEvent,  IEquatable<RemoveCustomerEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveCustomerEvent" /> class.
        /// </summary>
        ...
        /// <param name="CustomerConfig">CustomerConfig.</param>
        public RemoveCustomerEvent(string Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), CustomerConfig CustomerConfig = default(CustomerConfig))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for RemoveCustomerEvent and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        /// </summary>
        [DataMember(Name="customer_config")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((RemoveCustomerEvent)obj);
        }

        /// <summary>
        /// Returns true if RemoveCustomerEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of RemoveCustomerEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveCustomerEvent other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.CustomerConfig.Equals(other.CustomerConfig)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hash = hash * 59 + this.CustomerConfig.GetHashCode();
                return hash;
            }
        }
        ...
        public static bool operator ==(RemoveCustomerEvent left, RemoveCustomerEvent right)
        {
