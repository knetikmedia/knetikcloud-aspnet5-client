...
namespace IO.Swagger.Models
{
    ...
    public partial class VariableTypeResource :  IEquatable<VariableTypeResource>
    {
        ...
        /// <param name="Enumerable">Whether the type comes from a set of valid values that the system can provided (such as users).</param>
        ...
        public bool Equals(VariableTypeResource other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.Enumerable.Equals(other.Enumerable)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hash = hash * 59 + this.Enumerable.GetHashCode();
                    if (this.Name != null)
