...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class VideoProperty : FileProperty,  IEquatable<VideoProperty>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="VideoProperty" /> class.
        /// </summary>
        ...
        public VideoProperty(string Type = default(string), string Crc = default(string), string Description = default(string), string FileType = default(string), string Url = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for VideoProperty and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((VideoProperty)obj);
        }

        /// <summary>
        /// Returns true if VideoProperty instances are equal
        /// </summary>
        /// <param name="other">Instance of VideoProperty to be compared</param>
        /// <returns>Boolean</returns>
