...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageResourcestring :  IEquatable<PageResourcestring>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="PageResourcestring" /> class.
        /// </summary>
        ...
        public PageResourcestring(List<string> Content = default(List<string>), bool? First = default(bool?), bool? Last = default(bool?), int? Number = default(int?), int? NumberOfElements = default(int?), int? Size = default(int?), List<Order> Sort = default(List<Order>), long? TotalElements = default(long?), int? TotalPages = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((PageResourcestring)obj);
        }

        /// <summary>
        /// Returns true if PageResourcestring instances are equal
        /// </summary>
        /// <param name="other">Instance of PageResourcestring to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourcestring other)
        {
        ...
        public static bool operator ==(PageResourcestring left, PageResourcestring right)
        {
