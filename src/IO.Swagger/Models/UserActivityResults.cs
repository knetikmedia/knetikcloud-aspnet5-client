...
namespace IO.Swagger.Models
{
    ...
    public partial class UserActivityResults :  IEquatable<UserActivityResults>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((UserActivityResults)obj);
        }

        /// <summary>
        /// Returns true if UserActivityResults instances are equal
        /// </summary>
        /// <param name="other">Instance of UserActivityResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserActivityResults other)
        {
        ...
        public static bool operator ==(UserActivityResults left, UserActivityResults right)
        {
