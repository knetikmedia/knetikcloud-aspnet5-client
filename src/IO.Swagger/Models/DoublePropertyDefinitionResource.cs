...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoublePropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<DoublePropertyDefinitionResource>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="DoublePropertyDefinitionResource" /> class.
        /// </summary>
        ...
        public DoublePropertyDefinitionResource(PropertyFieldListResource FieldList = default(PropertyFieldListResource), string Name = default(string), bool? Required = default(bool?), string Type = default(string), double? Max = default(double?), double? Min = default(double?))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for DoublePropertyDefinitionResource and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Required == null)
            {
                throw new InvalidDataException("Required is a required property for DoublePropertyDefinitionResource and cannot be null");
            }
            else
            {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for DoublePropertyDefinitionResource and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((DoublePropertyDefinitionResource)obj);
        }

        /// <summary>
        /// Returns true if DoublePropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of DoublePropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoublePropertyDefinitionResource other)
        {
        ...
        public static bool operator ==(DoublePropertyDefinitionResource left, DoublePropertyDefinitionResource right)
        {
