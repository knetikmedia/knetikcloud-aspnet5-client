...
namespace IO.Swagger.Models
{
    ...
    public partial class UserActionLog :  IEquatable<UserActionLog>
    {
        ...
        /// <param name="CreatedDate">The date of the action, unix timestamp in seconds.</param>
        ...
        /// <param name="RequestId">The id of the api request that spawned the action, if generated internally.</param>
        /// <param name="UserId">The id of the user that took the action, if any. Read-only if not posting with LOGS_ADMIN.</param>
        public UserActionLog(string ActionDescription = null, string ActionName = null, long? CreatedDate = null, Dictionary<string, string> Details = null, string Id = null, string RequestId = null, int? UserId = null)
        {
        ...
        [DataMember(Name="action_description")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((UserActionLog)obj);
        }
        ...
        public static bool operator ==(UserActionLog left, UserActionLog right)
        {
