...
namespace IO.Swagger.Models
{
    ...
    public partial class ClientResource :  IEquatable<ClientResource>
    {
        ...
        /// <param name="GrantTypes">The oauth grant type as in: password (username/password auth), client_credentials (server-to-server, private clients), refresh_token (to allow clients to refresh their initial token), facebook, google, etc) See documentation for a compelte list..</param>
        ...
        /// </summary>
        /// <value>The oauth grant type as in: password (username/password auth), client_credentials (server-to-server, private clients), refresh_token (to allow clients to refresh their initial token), facebook, google, etc) See documentation for a compelte list.</value>
