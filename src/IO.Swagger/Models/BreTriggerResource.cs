...
namespace IO.Swagger.Models
{
    ...
    public partial class BreTriggerResource :  IEquatable<BreTriggerResource>
    {
        ...
        /// <param name="Parameters">A list of parameters that will be sent with the event when the trigger is fired. These must be included in the event and match the described types.</param>
        /// <param name="SystemTrigger">Where this trigger came from. System triggers cannot be removed or updated.</param>
        /// <param name="Tags">A list of tags for filtering.</param>
        ...
        public BreTriggerResource(string EventName = default(string), List<BreTriggerParameterDefinition> Parameters = default(List<BreTriggerParameterDefinition>), List<string> Tags = default(List<string>), string TriggerDescription = default(string), string TriggerName = default(string))
        {
